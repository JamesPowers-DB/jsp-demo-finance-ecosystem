...
CREATE OR REPLACE VIEW metric_variance_performance
WITH METRICS
LANGUAGE YAML
AS
$$
...
dimensions:
  ...
  - name: quarter_name
    ...
    comment: "Fiscal quarter name (e.g., Q1 2024)"
    display_name: "Quarter Name"
    synonyms:
      - period name
  ...
  - name: variance_percent
    expr: |
      CASE
        ...
        ELSE ((SUM(budgets.budget_amount) - SUM(actuals.actual_amount)) / SUM(budgets.budget_amount)) * 100
      END
